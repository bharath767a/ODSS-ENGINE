...
// Keep these SPECIFIC — loose fragments like 'IT ' matched "circuit/profit/unit",
// 'EV' matched "revenue", 'US ' matched "versus", polluting news→stock linking.
const SECTOR_KW: Record<string,string[]> = {
  BANKING:['BANKING','BANK ','NPA','RBI','LENDER'], FINANCIAL:['NBFC','FINANCE','FINANCIAL','INSURANCE','BROKERAGE'],
  IT:['SOFTWARE','INFORMATION TECHNOLOGY','IT SERVICES','IT SECTOR','IT STOCK','IT MAJOR','SEMICONDUCTOR','INFOSYS','WIPRO','HCLTECH','TECH MAHINDRA'], PHARMA:['PHARMA','DRUGMAKER','HEALTHCARE','CIPLA','SUN PHARMA','DR REDDY','USFDA'],
  AUTO:['AUTOMOBILE','AUTO SECTOR','AUTO STOCK','TWO-WHEELER','PASSENGER VEHICLE','MARUTI','TATA MOTORS','ELECTRIC VEHICLE','TRACTOR'], FMCG:['FMCG','HINDUSTAN UNILEVER','NESTLE','CONSUMER GOODS'],
  METAL:['METAL','STEEL','ALUMINIUM','COPPER','TATA STEEL','JSW','HINDALCO','MINING'], ENERGY:['CRUDE','PETROLEUM','ONGC','POWER SECTOR','ENERGY SECTOR','OPEC','NATURAL GAS'],
  INFRA:['INFRASTRUCTURE','CONSTRUCTION','HIGHWAY','CEMENT'], TELECOM:['TELECOM','AIRTEL','VODAFONE','JIO'],
};
...
const EVENT_KW: Record<EventType,string[]> = {
  ...
  GLOBAL:['GLOBAL MARKET','WALL STREET','ASIAN MARKET','US MARKET','US FED','DOW JONES','NASDAQ','NIKKEI','FEDERAL RESERVE'],
