  ...
  apps: [
    {
      ...
      watch: false,
      out_file: '/home/z/odss-data/pm2-logs/odss-web-out.log',
      error_file: '/home/z/odss-data/pm2-logs/odss-web-error.log',
      merge_logs: true,
      time: true,
      kill_timeout: 10000,
    ...
    },
    {
      ...
      watch: false,
      out_file: '/home/z/odss-data/pm2-logs/odss-market-out.log',
      error_file: '/home/z/odss-data/pm2-logs/odss-market-error.log',
      merge_logs: true,
      time: true,
      kill_timeout: 10000,
